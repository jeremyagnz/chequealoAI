...
> ⚠️ Nota de seguridad: esta versión es 100% frontend y la API key puede extraerse desde DevTools/tráfico de red. Úsala solo como demo/prototipo, con límites de uso y monitoreo activo en OpenAI.
